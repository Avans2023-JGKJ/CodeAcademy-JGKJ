...
public class OverzichtFXMLController implements Initializable {
    ...
    System.out.println("Overzicht 3");
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML_Bestanden/ov3ScreenAdmin.fxml"));
            root = loader.load();
            stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            scene = new Scene(root);
            stage.setScene(scene);
    ...
    System.out.println("Overzicht 4");
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML_Bestanden/ov4ScreenAdmin.fxml"));
            root = loader.load();
            stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            scene = new Scene(root);
            stage.setScene(scene);
